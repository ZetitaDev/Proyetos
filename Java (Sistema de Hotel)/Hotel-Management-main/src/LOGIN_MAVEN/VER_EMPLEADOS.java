...
public class VER_EMPLEADOS extends javax.swing.JPanel {
   ...
   public VER_EMPLEADOS(DefaultTableModel modeloTabla) {
        this.modeloTabla = modeloTabla;
        initComponents();
        jTable2.setModel(this.modeloTabla); // Configura el modelo de tabla después de la inicialización de componentes
   ...
   public void actualizarTabla(Object[][] data, String[] columnNames) {
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre", "Apellido", "Cargo", "Salario", "Fecha_Contratación", "Correo_Electronico", "Teléfono"
            }
        ) {
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, -1, 260));
